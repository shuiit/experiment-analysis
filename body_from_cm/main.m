...
experiment_path = 'H:\My Drive\dark 2022\2023_08_09_60ms\'
easywand_path = [experiment_path,'10_8_23_allmovs_easyWandData']
...
save('cm_smoothed_mov_60ms','cm_smoothed_mov')
save('cm_raw_mov_60ms','cm_raw_mov')
save('time_60ms','time')
...
%%
load('cm_smoothed_mov_10ms')
load('cm_raw_mov_10ms')
% load('time')
mean_v = []
